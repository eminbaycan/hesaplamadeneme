    ...
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          Yeni veya 2. el araç alımlarınızda kullanacağınız taşıt kredisinin aylık ödeme planını ve faiz detaylarını hesaplayın.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-black/5 dark:border-white/10 rounded-3xl p-6 md:p-8 shadow-sm">
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-slate-600 dark:text-slate-400 space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Taşıt kredisi, sıfır veya ikinci el otomobil, ticari araç veya motosiklet alımlarını finanse etmek için kullanılan bireysel bir kredi türüdür. Araç genellikle kredi süresi boyunca banka tarafından rehin alınır.
            </p>
          </section>
      ...
      <RelatedTools category="kredi" currentToolId="tasit-kredisi" />
