  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mb-6 font-medium">
        ...
        <ChevronRight size={14} />
        <span className="text-slate-800 dark:text-slate-300">İhtiyaç Kredisi Hesaplama</span>
      </div>

      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">İhtiyaç Kredisi Hesaplama 2026 - Ücretsiz ve Hızlı Sonuçlar</h1>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          Kişisel ihtiyaçlarınız için çekeceğiniz kredinin aylık taksitlerini, toplam geri ödeme miktarını ve faiz yükünü anında hesaplayın.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-black/5 dark:border-white/10 rounded-3xl p-6 md:p-8 shadow-sm">
        <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-6 flex items-center gap-2 border-b border-black/5 dark:border-white/10 pb-4">
          ...
          İhtiyaç Kredisi Hesaplama Hakkında Her Şey ve Sıkça Sorulan Sorular
        </h3>
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-slate-600 dark:text-slate-400 space-y-8 leading-relaxed">
          ...
          <section>
            <h4 className="text-[17px] font-bold text-slate-800 dark:text-slate-200 mb-3">İhtiyaç Kredisi Hesaplama Nedir ve Nasıl Hesaplanır?</h4>
            <p>
              İhtiyaç kredisi, tüketicilerin kişisel ihtiyaçlarını karşılamak amacıyla bankalardan veya finans kuruluşlarından temin ettikleri kredidir. Bu hesaplama aracı, sabit taksitli kredi hesaplama formülü kullanarak, aylık taksitleri eşit olarak böler.
            </p>
          </section>
      ...
      <RelatedTools category="kredi" currentToolId="ihtiyac-kredisi" />
