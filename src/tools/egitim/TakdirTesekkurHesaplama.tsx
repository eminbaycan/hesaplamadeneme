...
export default function TakdirTesekkurHesaplama() {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Takdir Teşekkür Hesaplama 2026 - Ücretsiz ve Hızlı Sonuçlar</h1>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                {sonuc !== null && (
                  <button
                    type="button"
                    onClick={() => {
                      navigator.clipboard.writeText(`Dönem Ortalaması: ${sonuc.ortalama.toFixed(2)} - Belge: ${sonuc.belge}`);
                      setCopied(true);
