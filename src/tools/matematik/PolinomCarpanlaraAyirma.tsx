...
export default function PolinomCarpanlaraAyirma() {
  ...
  const hesapla = () => {
    ...
    setError(null);
      ...
      setSonuc('(x - 2)(x - 3)');
      setDetay('Çarpanlara Ayırma: x² - 5x + 6 ifadesinde çarpımları +6, toplamları -5 olan sayılar -2 ve -3\'tür.');
  };
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mb-6 font-medium">
        ...
        <ChevronRight size={14} />
        <span className="text-slate-800 dark:text-slate-300">Polinom Çarpanlara Ayırma</span>
      </div>

      {/* 2. BAŞLIK VE AÇIKLAMA */}
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Polinom Çarpanlara Ayırma 2026 - Ücretsiz ve Hızlı Sonuçlar</h1>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          İkinci ve üçüncü dereceden polinomları çarpanlarına ayırın, köklerini ve özdeşlik açılımlarını görüntüleyin.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-black/5 dark:border-white/10 rounded-3xl p-6 md:p-8 shadow-sm">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 uppercase tracking-wide">Polinom İfadesi (ax² + bx + c)</label>
                <input
                  type="text"
                  value={val1}
                  ...
                  {sonuc !== null && (
                    <div className="mt-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-black/5 dark:border-white/5">
                      ...
                      <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
                        Polinomun daha sade lineer çarpanların çarpımı şeklinde yazılmış halidir.
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 mb-8 space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed shadow-sm">
        ...
        <div>
          <h4 className="text-base font-bold text-slate-900 dark:text-white mb-2">Polinom Çarpanlara Ayırma Nedir ve Nasıl Hesaplanır?</h4>
          <p className="text-sm">
            Polinom Çarpanlara Ayırma, matematik ve geometri alanında sıkça başvurulan temel hesaplama disiplinlerinden biridir. İkinci ve üçüncü dereceden polinomları çarpanlarına ayırın, köklerini ve özdeşlik açılımlarını görüntüleyin. Hesaplama aracımız girilen tüm sayısal parametreleri analiz ederek kurallara uygun biçimde sonuçlandırır.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm">
            <div className="border-b border-slate-100 dark:border-slate-800 pb-3">
              <h5 className="font-bold text-slate-900 dark:text-white mb-1">Çarpanlara ayırma neden önemlidir?</h5>
              <p>Karmaşık cebirsel ifadelerin sadeleştirilmesini ve polinom denklemlerinin köklerinin kolayca bulunmasını sağlar.</p>
            </div>
            <div className="border-b border-slate-100 dark:border-slate-800 pb-3">
              <h5 className="font-bold text-slate-900 dark:text-white mb-1">Tam kare özdeşliği nedir?</h5>
              <p>(a + b)² = a² + 2ab + b² ve (a - b)² = a² - 2ab + b² ifadeleri temel tam kare özdeşlikleridir.</p>
            </div>
          </div>
        </div>
      </div>

            <div className="mt-8"><RelatedTools currentToolId="polinom-carpanlara-ayirma-hesaplama" category="matematik" /></div>
<Disclaimer />
    </div>
  );
}
