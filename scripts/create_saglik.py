...
template_vki = """import React, { useState } from 'react';
...
export default function VkiHesaplama() {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Vücut Kitle İndeksi (VKİ) Hesaplama</h1>
...
with open("src/tools/saglik/VkiHesaplama.tsx", "w") as f: f.write(template_vki)

template_kalori = """import React, { useState } from 'react';
import { ChevronRight, RefreshCw, Copy, Info, AlertCircle } from 'lucide-react';
import { Link } from 'react-router-dom';
import { ToolIcon } from '../../components/icons/ToolIcon';
import { AdSlot } from '../../components/ads/AdSlot';
...
export default function KaloriHesaplama() {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Günlük Kalori İhtiyacı Hesaplama</h1>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
...
with open("src/tools/saglik/KaloriHesaplama.tsx", "w") as f: f.write(template_kalori)
