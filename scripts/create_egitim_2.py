...
export default function NotOrtalamasiHesaplama() {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Ağırlıklı Not Ortalaması Hesaplama</h1>
...
with open("src/tools/egitim/NotOrtalamasiHesaplama.tsx", "w") as f: f.write(template)
